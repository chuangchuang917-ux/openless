...
export let mockStylePacks: StylePack[] = [
    ...
    ),
    {
        ...makeMockStylePack(
            ...
            "light",
            "創作者口播",
            "給短影片口播和社區貼文使用，句子更緊湊，保留情緒和節奏。",
            "你是一個負責整理創作者口播稿的編輯。請把輸入整理成適合發帖和口播的自然文本，保留節奏感，不要補充原文沒有的資訊。",
            ["社區", "口播", "節奏感"],
        ),
...
export function mockResetBuiltinStylePack(id: string): StylePack {
    const builtinDefaults: Record<string, StylePack> = {
        ...
        "builtin.light": makeMockStylePack(
            ...
            "輕度潤色",
            "把口述整理成順暢、自然、可直接發送的文字，不擴寫事實。",
            "把口述整理成自然、順暢、可直接發送的文字，去掉口頭禪和重複，保留原意與語氣。",
            ["溝通", "自然"],
        ),
        "builtin.structured": makeMockStylePack(
            ...
            "structured",
            "清晰結構",
            "面向 AI 程式設計協作、技術排障和模型資訊，優先保證術語與結構準確。",
