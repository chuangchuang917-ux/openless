...
export const zhTW: typeof zhCN = {
  ...
  style: {
    ...
    customPromptTitle: '自訂提示詞',
    customPromptPlaceholder: '可選，追加到這個風格的內建 system prompt 末尾。',
    customPromptHint: '留空則保持目前行為不變。儲存後會在該風格的潤色和 repolish 中生效；按 Ctrl/Cmd+Enter 也可儲存。',
    ...
    modes: {
      ...
      light: { name: '輕度潤色', desc: '去口癖、補標點，整理為可發送的自然文字。', sample: '讓轉寫聽起來不像念稿——保留語氣和表達習慣，但行文流暢。' },
